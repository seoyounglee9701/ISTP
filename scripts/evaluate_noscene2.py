...
parser.add_argument('--model_path', default=os.getcwd() + '/output/noscene/obs8/state1/2', type=str)
# parser.add_argument('--model_path', default=os.getcwd() + '/obs_12/wo_scene_2/state_v2/2', type=str)
parser.add_argument('--num_samples', default=20, type=int)
parser.add_argument('--dset_type', default='test', type=str)
parser.add_argument('--state_type', default=4, type=int) # v0: no state, v1: acc1+acc2+speed+ang, v2: acc1+acc2+speed, v3: acc1+acc2+ang, v4: speed
