...
from mmt.models2.mmtf_scene_v2_2 import TrajectoryGenerator # 
...
parser.add_argument('--model_path', default=os.getcwd() + '/output/scene_v2_2/state4/obs8/2', type=str)
...
parser.add_argument('--num_lstm_layers', default=1, type=int) # v0: no state, v1: acc1+acc2+speed+ang, v2: acc1+acc2+speed, v3: acc1+acc2+ang, v4: speed
parser.add_argument('--num_tf_layers', default=4, type=int) # v0: no state, v1: acc1+acc2+speed+ang, v2: acc1+acc2+speed, v3: acc1+acc2+ang, v4: speed
