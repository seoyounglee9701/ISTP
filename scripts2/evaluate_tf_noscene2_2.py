...
from mmt.models2.mmtf_noscene_v5 import TrajectoryGenerator # model 불러오기
...
parser.add_argument('--model_path', default=os.getcwd() + '/output/noscene_v2_2/state3/obs12/2', type=str)
