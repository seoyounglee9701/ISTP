...
from mmt.models2.mmtf_noscene_v0 import TrajectoryGenerator # model 불러오기
...
parser.add_argument('--model_path', default=os.getcwd() + '/output/noscene_v0/obs12/1', type=str)
