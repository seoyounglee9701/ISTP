...
from mmt.models2.mmtf_noscene_v1_2 import TrajectoryGenerator # model 불러오기
...
parser.add_argument('--model_path', default=os.getcwd() + '/output/noscene_v1_2/state1/obs12/1', type=str)
