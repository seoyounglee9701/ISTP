...
_path = _path.split("/")[:-1]
_path = "/".join(_path)
print(f"sys에 등록할 경로 [_path]:{_path}")
...
from mmt.models2_eth.mmtf_noscene_v2_2 import TrajectoryGenerator # model 불러오기
# from mmt.models2_eth.mmtf_noscene_nostate import TrajectoryGenerator # model 불러오기
...
parser.add_argument('--model_path', default=os.getcwd() + '/output/noscene_v2_2/state2/obs8/3', type=str)
